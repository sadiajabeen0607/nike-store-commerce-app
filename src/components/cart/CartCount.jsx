...
const CartCount = ({ onCartToggle, onClearCartItems, totalQTY }) => {
  return (
    <>
        <div className='bg-white flex items-center justify-between px-3 sticky top-0 left-0 right-0 h-11 w-full'>
            <div className='flex items-center gap-3'>
                <div className='grid items-center cursor-pointer'>
                    <ChevronDoubleLeftIcon onClick={onCartToggle} className='w-5 h-5 text-slate-900 hover:text-orange-500 stroke-[2]' />
                </div>
